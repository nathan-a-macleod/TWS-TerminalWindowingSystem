...
helpWin.addLabel("", 13, 2, "WASD (LowerCase): Resizes the selected window.")
...
helpWin.addLabel("", 19, 2, "This window has a few buttons at the top - one of them is to close the window, the rest don't do anything.")