...
helpWin.addLabel("", 9, 2, "Up & down Arrows: Scrolling.")
helpWin.addLabel("", 10, 2, "Left & right Arrow Keys: Highlight a button.")
helpWin.addLabel("", 11, 2, "ENTER: 'Click' a selection.")
helpWin.addLabel("", 12, 2, "WASD (UpperCase): Moves the selected window.")
helpWin.addLabel("", 13, 2, "Q, E (UpperCase): Selects a different window.")
