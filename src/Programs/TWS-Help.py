...
helpWin.addLabel("", 12, 2, "WASD: Moves the selected window.")
helpWin.addLabel("", 14, 2, "Most programs will have at least a few buttons to select. Some of those buttons may be in the toolbar (look at the top of the screen).")
helpWin.addLabel("", 15, 2, "This window has a few buttons at the top - one of them is to close the window, the rest don't do anything.")
